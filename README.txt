...
Contributors: wordpress.org userid's
...
= What forms does the free version work with? =

Contact Form 7.

= What froms does the premium version work with? =

Contact Form 7, Gravity Forms, WP Forms, Ninja Forms. Also Zapier Capabilities are Included. 

= What UTM Parameters are Captured? =

We are captureing the following UTM parameters: Source, Medium, Term, Content, and Campaign. We are also looking for GCLIDs.
